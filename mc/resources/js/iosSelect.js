	...
	IosSelect.prototype = {
		...
		setOneLevel: function(oneLevelId, twoLevelId, threeLevelId) {
			...
			oneLevelData.forEach(function(v, i, o) {
				if (v.ID === oneLevelId) {
					oneHtml += '<li ' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.Name + '</li>';
					atIndex = i + 1 + 3;
				} else {
					oneHtml += '<li ' + iosSelectUtil.attrToHtml(v) + '>' + v.Name + '</li>';
				}
			});
			oneHtml += '<li></li>';
			oneHtml += '<li></li>';
		...
		setTwoLevel: function(oneLevelId, twoLevelId, threeLevelId) {
			...
			twoLevelData.forEach(function(v, i, o) {
				if (v.ID === twoLevelId) {
					twoHtml += '<li ' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.Name + '</li>';
					atIndex = i + 1 + 3;
				} else {
					twoHtml += '<li ' + iosSelectUtil.attrToHtml(v) + '>' + v.Name + '</li>';
				}
			});
			twoHtml += '<li></li>';
			twoHtml += '<li></li>';
		...
		setThreeLevel: function(oneLevelId, twoLevelId, threeLevelId) {
			...
			threeLevelData.forEach(function(v, i, o) {
				if (v.ID === threeLevelId) {
					threeHtml += '<li ' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.Name + '</li>';
					atIndex = i + 1 + 3;
				} else {
					threeHtml += '<li ' + iosSelectUtil.attrToHtml(v) + '>' + v.Name + '</li>';
				}
			});
			threeHtml += '<li></li>';
			threeHtml += '<li></li>';
